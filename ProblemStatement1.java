package com.cg.ReqresAssignment;
...
public class ProblemStatement1 {
	...
	public static void main(String[] args) throws IOException {
			...
			File f = new File("C:\\Users\\ALTAFH\\OneDrive - Capgemini\\Desktop\\Word Files");
			...
			} } else if (file.getName().contains("pdf")) { PDDocument document = PDDocument.load(file);
			...
			} else { System.out.println("matched keywords count is " + count);
